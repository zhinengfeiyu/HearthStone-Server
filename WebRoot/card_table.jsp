...
%>
  <table width="80%" border="1" align="center">
  	...
  	<tr>
  	<td width="10%">
  		<img alt="这是图片" src=<%="'images/"+cardName+".jpg'" %> width="52" height="74" 
  				onmouseover="showing('<%="images/"+cardName+".jpg"%>');" onmouseout="clearing();"/>
  	</td>
  	<td width="20%"><%=cardName%></td>
	<td width="10%"><%=colors[rs.getInt(2)]%></td>
	<td width="10%"><%=jobs[rs.getInt(3)]%></td>
	<td width="10%"><%=rs.getInt(4)%></td>
	<td width="40%"><%=rs.getString(5)%></td>
  	<%} %>
  </table>
